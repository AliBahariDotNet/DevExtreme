...
const componentConfig = {
  props: {
    ...
    disabled: Boolean,
    disabledDates: [Array, Function] as PropType<Array<Date> | (((data: { component: dxDateBox, date: Date, view: string }) => boolean))>,
    ...
    pickerType: String as PropType<DatePickerType>,
    placeholder: String,
    readOnly: Boolean,
    rtlEnabled: Boolean,
    ...
    value: [Date, Number, String] as PropType<Date | null | number | string>,
