...
const persianDateUtils = {
    ...
    fixTimezoneGap: dateUtils.fixTimezoneGap,
    getTimezonesDifference: dateUtils.getTimezonesDifference,
    getMachineTimezoneName: dateUtils.getMachineTimezoneName,
    getRangesByDates: dateUtils.getRangesByDates,
