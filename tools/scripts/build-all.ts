...
const injectDescriptions = () => {
    ...
    sh.exec(`git clone -b ${MAJOR_VERSION} --depth 1 --config core.longpaths=true https://github.com/AliBahariDotNet/devextreme-documentation.git ${DOCUMENTATION_TEMP_DIR}`);
